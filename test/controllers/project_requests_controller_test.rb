...
class ProjectRequestsControllerTest < ActionController::TestCase
  ...
  test "should create project_request" do
    assert_difference('ProjectRequest.count') do
      post :create, project_request: { department_id: @project_request.department_id, location_id: @project_request.location_id, project_id: @project_request.project_id, skill_id: @project_request.skill_id }
    end
  ...
  test "should update project_request" do
    patch :update, id: @project_request, project_request: { department_id: @project_request.department_id, location_id: @project_request.location_id, project_id: @project_request.project_id, skill_id: @project_request.skill_id }
    assert_redirected_to project_request_path(assigns(:project_request))
  end
